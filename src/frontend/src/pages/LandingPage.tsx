  ...
  const features = [
    {
      ...
      description:
        "Create and manage multiple events with schedules, venues, and details",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      title: "Notifications",
      description:
        "Send updates and reminders to participants via email and WhatsApp",
    },
    {
      icon: FileText,
      title: "Export Reports",
      description:
        "Generate and download participant reports and attendance data",
    },
  ];
    ...
    <div className="container py-12">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Everything you need to organize successful college events, hackathons,
          and fests
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl p-12 text-center">
        ...
        <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
          Join Campus EventHub today and streamline your event management
          process
        </p>
        {!isAuthenticated && (
